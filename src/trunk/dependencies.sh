...
# installing ghcr.io/devcontainers-contrib/features/npm-package:1
featmake "ghcr.io/devcontainers-contrib/features/npm-package:1" -PACKAGE "@trunkio/launcher" -VERSION "$VERSION" 
