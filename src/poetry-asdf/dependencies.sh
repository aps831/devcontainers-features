...
# installing ghcr.io/aps831/devcontainers-features/python-asdf:1.0.1
featmake "ghcr.io/aps831/devcontainers-features/python-asdf:1.0.1" -VERSION "latest" 

# refresh PATH
PS1='\s-\v\$' source /etc/profile
# installing ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1
featmake "ghcr.io/devcontainers-contrib/features/asdf-package:1.0.1" -PLUGIN "poetry" -VERSION "$VERSION" 
